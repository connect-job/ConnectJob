		...
		<div id="memberEnroll">
			<form action="${path }/cMemberEnrollEnd.do" method="post" class="signup-frm" autocomplete="off">
				...
				<div class="enroll-item">
					...
					<div class="right">
						<input type="text" class="CMember" id="CMemberBNum" name="CMemberBNum" required/>
				...
				<div class="enroll-item">
					...
					<div class="right"><input type="text" class="CMember" id="CMemberId" name="CMemberId" required/></div>
				</div>
				...
				<div class="enroll-item">
					...
					<div class="right"><input type="password" class="CMember" id="CMemberPwCk" name="CMemberPw" required/></div>
				</div>

				<div class="enroll-item">
					<div class="left">담당자 이름</div>
					<div class="right"><input type="text" class="CMember" id="CMemberName" name="CMemberName" required/></div>
				</div>

				<div class="enroll-item">
					<div class="left">담당자 연락처</div>
					<div class="right"><input type="text" class="CMember" id="CMemberPhone" name="CMemberPhone" required/></div>
				</div>

				<div class="enroll-item">
					<div class="left">담당자 이메일</div>
					<div class="right"><input type="email" class="CMember" id="CMemberEmail" name="CMemberEmail" required /></div>
				</div>
				...
				<div class="enroll-text">
					전체동의 <input type="checkbox" class="chk" id="ACCEPT_TERMS" value="ACCEPT_TERMS_ALL" />
				</div>
