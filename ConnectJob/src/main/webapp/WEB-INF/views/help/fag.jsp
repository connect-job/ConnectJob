...
<section>
	...
	<div class="faq">
		...
		<div class="q" onclick="$(this).next().toggle()">Q : 가입한 이메일 계정이 기억나지 않아요.</div>
		...
		<div class="q" onclick="$(this).next().toggle()">Q : 회원정보 중에 생년월일과 성별이 잘못 기입되었습니다. 어떻게 하나요?</div>
...
<br>· E-mail: helpcs@connectjob.co.kr</div>
		...
		<div class="q" onclick="$(this).next().toggle()">Q : 이력서 제목 수정은 어떻게 하나요?</div>
...
[커넥트잡 고객지원팀 02-789-4562] </div>
		...
		<div class="q" onclick="$(this).next().toggle()">Q : 채용공고를 보고 지원을 하였습니다. 채용공고에 내용과 전혀 다른 기업은 어떻게 하나요?</div>
...
<div class="q" onclick="$(this).next().toggle()">Q : 평균연봉은 어떻게 산출하나요?</div>
