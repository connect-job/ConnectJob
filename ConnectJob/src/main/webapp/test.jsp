...
<section>
        <div id="company-container">
            ...
            <div class="company-middle">
	            <ul class="tabs">
	                <li class="tab-link current" data-tab="search_location">지역선택</li>
	                <li class="tab-link" data-tab="search_job">직종선택</li>
	                <li class="tab-link" data-tab="search_ETC">상세선택</li>
	            </ul>
                <div id="search_location" class="search_location tab-content current">
                    <div id="search_left">
                        <ul>
                            <li>서울</li>
                            <li>경기</li>
                ...
                <div id="search_ETC" class="search_location tab-content">
                    <div id="search_left_ETC">
                        <ul>
                            <li>연봉</li>
                            <li>고용형태</li>
                            <li>성별</li>
