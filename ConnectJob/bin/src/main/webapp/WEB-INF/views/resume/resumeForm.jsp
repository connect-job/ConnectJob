...
<section>
	<div id="resume-container">
		...
		<div class="item">
			...
			<div class="right"><input type="text" id="name" required></div>
		</div>
		<div class="item">
		...
		<div class="item">
			...
			<div class="right"><input type="email" id="email" placeholder="example@connectjob.com"></div>
		</div>
		<div class="item">
			<div class="left">핸드폰</div>
			<div class="right"><input type="text" id="phone" placeholder="-을 제외하고 작성"></div>
		</div>
		...
		<div class="item">
			...
			<div class="right">
				...
				<label><input type="checkbox" name="hopeArea" id="ho2" value='데이터베이스·DBA' />데이터베이스·DBA</label><br>
				...
				<label><input type="checkbox" name="hopeArea" id="ho2" value='웹마스터·QA·테스터' />웹마스터·QA·테스터</label><br>
		...
		<div class="item">
			...
			<div class="right">
				...
				<label><input type="checkbox" name="hopeArea" id="ho1" value='ERP·시스템분석·설계' />네트워크·통신·모바일</label><br>
